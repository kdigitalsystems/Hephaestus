...
- The static UI uses those fields for the morning brief, richer search filters, watchlist cards, comparison views, trust badges, source/evidence modals, sector pages, and company Decision Briefs.
